    ...
    <div className="w-full max-w-md mx-auto">
      <div className="mb-6 text-center sm:text-left">
        ...
        <p className="mt-1 text-sm text-white/60">
          Sign up to create custom short links and track analytics
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/20 bg-white/5 px-4 py-2.5 text-base text-white placeholder:text-white/40 outline-none transition focus:border-nyc-yellow focus:ring-4 focus:ring-nyc-yellow/20 disabled:cursor-not-allowed disabled:opacity-60"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              required
              aria-invalid={Boolean(error)}
              className="w-full rounded-lg border border-white/20 bg-white/5 px-4 py-2.5 pr-12 text-base text-white placeholder:text-white/40 outline-none transition focus:border-nyc-yellow focus:ring-4 focus:ring-nyc-yellow/20 disabled:cursor-not-allowed disabled:opacity-60"
            />
            <button
              type="button"
